...
export class FlightLogParser {
  ...
  parseHeader(startOffset, endOffset) {
    ...
    // Clear unkown headers incase this got called before.
    ...
    const { debugModes, flightLogFlightModeNames } = adjustFieldDefsList(
      this.sysConfig.firmwareType,
      this.sysConfig.firmwareVersion
    );
    this.debugModes = debugModes;
    this.flightLogFlightModeNames = flightLogFlightModeNames;
